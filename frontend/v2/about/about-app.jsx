  ...
  return React.createElement('div', null,
    ...
    React.createElement('div', { className: 'ab-page' },
      ...
      React.createElement('div', { className: 'ab-meta' },
        React.createElement('div', null, '基于原作者 P0luz 的 Ombre Brain 项目创新而成'),
        React.createElement('div', { style: { marginTop: '16px', color: 'var(--accent)' } },
          React.createElement('a', { href: 'https://github.com/P0luz/Ombre-Brain', target: '_blank', rel: 'noopener', style: { color: 'var(--accent)', fontSize: '11px' } }, 'github.com/P0luz/Ombre-Brain'),
        ),
      ),
    ),
  );
