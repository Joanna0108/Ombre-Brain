...
function SettingsApp() {
  ...
  useEf(function() {
    ...
    Promise.all([
      ...
      if (r[3]) setSampling(r[3]); if (r[4] && r[4].name) setHumanName(r[4].name);
      if (r[5] && r[5].value != null) setHostVault(r[5].value);
      if (r[6]) setBucketsData(Array.isArray(r[6]) ? r[6] : []);
  ...
  return ce('div', null,
    ...
    ce('div', { className: 'st-page' },
      ce('div', { className: 'st-hd' }, ce('h1', null, '⚙️ 设置 · test8')),
      ...
      ce('div', { className: 'st-section' },
        ...
        ce('div', { style: { marginTop: 16 } },
          ce('div', { className: 'st-sub', style: { marginBottom: 6 } }, '宿主机目录'),
          ce('div', { className: 'st-row' },
      ...
      ce('div', { className: 'st-section' },
        ce('h3', null, '③ 引擎'), ce('div', { className: 'st-sub' }, '脱水 LLM'),
