...
function SettingsApp() {
  ...
  useEf(function() {
    ...
    Promise.all([
      ...
      if (r[7] && r[7].value != null) setHostVault(r[7].value);
      if (r[8]) setBucketsData(Array.isArray(r[8]) ? r[8] : []);
